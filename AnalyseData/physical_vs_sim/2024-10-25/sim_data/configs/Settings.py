...
class Settings():
    ...
    ## Map ##
    MAP_NAME = "IPZ10"  # hangar3, hangar9, hangar12, hangar14, hangar16, london3_small, london3_large, ETF1, ini10, icra2022, RCA1, RCA2
    MAP_PATH = os.path.join("utilities", "maps", MAP_NAME)
    MAP_CONFIG_FILE = os.path.join(MAP_PATH, MAP_NAME+".yaml")
    
    ## Friction ##
    SURFACE_FRICITON = 0.65 # Surface friction coefficient
    ...
    GLOBAL_WAYPOINT_VEL_FACTOR = 0.65
    ...
    CONTROL_NOISE_DURATION = 20 # Number of timesteps for which the control noise is applied
