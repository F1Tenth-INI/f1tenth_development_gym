...
python TrainingLite/rl_racing/run_training.py --SIMULATION_LENGTH 300000 --model-name OriginalReward2
...
python TrainingLite/rl_racing/run_training.py --SIMULATION_LENGTH 300000 --model-name OriginalReward3
...
python TrainingLite/rl_racing/run_training.py --SIMULATION_LENGTH 300000 --model-name OriginalReward4
