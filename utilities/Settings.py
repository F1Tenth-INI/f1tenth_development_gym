class Settings():
    COMPUTER_INSTANCE = "Florian Private Laptop"
    ### Environment ###
    ...
    MAP_CONFIG_FILE =  "utilities/maps/hangar11/config_map_gym.yaml"   
    ...
    CONTROLLER = 'mpc'  # Options: 'mpc', 'ftg' (follow the gap), neural (neural network), 'pp' (pure pursuit), 'manual' (manual driving)
