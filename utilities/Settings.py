...
class Settings():
    ...
    SIM_ODE_IMPLEMENTATION = "pacejka"  # Use the implementation 'pacejka', ='ODE_TF' or implement a new one
    ...
    DYNAMIC_SURFACE_FRICTION = [False, 1500] # Dynamic surface friction [Bool, after how many steps to change]
