class Settings:
    ...
    CONTROLLER = 'ftg'  # Options: 'mpc', 'ftg' (follow the gap), neural (neural network),  Out of order: 'pp' (pure pursuit)
    ...
    NET_NAME = 'Dense-68IN-32H1-32H2-2OUT-1'
    ACCELERATION_TIME = 50       #nni 50, mpc 10
    ACCELERATION_AMPLITUDE = 2        #nni 2, mpc 10
    ...
    EXPERIMENT_LENGTH = 1500 #36000  # in timesteps, only valid if DISABLE_AUTOMATIC_TIMEOUT is True.
    ...
    #Set Noise Level
    NOISE_LEVEL_TRANSLATIONAL_CONTROL = 1.0 # ftg: 0.5  # mppi: 2.0
    NOISE_LEVEL_ANGULAR_CONTROL = 0.13  # ftg: 0.05  # mppi: 3.0
