...
from utilities.maps_files.tum_track_db.transform_track import *

map_name = "Hockenheim"
pixel_per_m = 10
image_margin = 10

# Post waypoint calculation (only drawing settings)
# drawing_scale = 0.1
track_width_sumand = 0.4
width_factor = 2.
scaling = 0.05 # Dont touch

transform_track_data(map_name, scaling, 1., image_margin)
...
track_points = pd.read_csv("utilities/maps_files/tum_track_db/widened/"+map_name+".csv").to_numpy()
