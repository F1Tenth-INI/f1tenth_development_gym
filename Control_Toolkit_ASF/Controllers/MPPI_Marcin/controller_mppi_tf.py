...
from Control_Toolkit_ASF.Controllers.MPPI_Marcin.template_controller import template_controller
...
cost_function_cmd = 'from Control_Toolkit_ASF.Controllers.MPPI_Marcin.cost_functions.'+cost_function+' import q, phi'
