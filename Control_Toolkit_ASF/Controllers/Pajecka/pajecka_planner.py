...
from Control_Toolkit_ASF.Controllers.Pajecka.pajecka_helpers import *
...
'''
class PajeckaPlanner(template_planner):
    """
    Example Planner
    """
    ...
    def __init__(self):
        ...
        print("Initializing Pajecka Param Determination")
        ...
        self.angular_control = np.deg2rad(90)
        self.translational_control = 0.
        self.timestep = Settings.TIMESTEP_CONTROL
        self.direction = Settings.REVERSE_DIRECTION
    ...
    def process_observation(self, ranges=None, ego_odom=None):
        ...
        steering_angle = self.angular_control
        steering_angle += 0.02 * self.timestep
