...
class Settings():
    ...
    ENV_CAR_PARAMETER_FILE = "utilities/car_files/custom_car_parameters.yml" # Car parameters for simulated car
    # ENV_CAR_PARAMETER_FILE = "utilities/car_files/custom_car_parameters_lower_mu.yml" # Car parameters for simulated car
    ...
    EXPERIMENT_LENGTH = 2500  # in timesteps, only valid if DISABLE_AUTOMATIC_TIMEOUT is True.
    ...
    FACTOR_APPLIED_TRANSLATIONAL_CONTROL = 1.
    ...
    CONTROLLER = 'mpc'  # Options: 'manual' (requires connected joystick) ,'mpc', 'ftg' (follow the gap), neural (neural network),  'pp' (pure pursuit), 'stanley' (stanley controller), 'random'
    # CONTROLLER = 'random'
    ...
    MPC_CAR_PARAMETER_FILE = "utilities/car_files/custom_car_parameters.yml"
    # MPC_CAR_PARAMETER_FILE = "utilities/car_files/custom_car_parameters_lower_mu.yml"
