...
Settings.NOISE_LEVEL_CONTROL = [0.2, 0.5] 
Settings.CONTROL_NOISE_DURATION = 20 

Settings.START_FROM_RANDOM_POSITION = True 


Settings.START_FROM_RANDOM_POSITION = True
Settings.DATASET_NAME = "_MPC_Noise"
...
global_waypoint_velocity_factors = [0.3, 0.5, 0.7, 0.8, 0.9, 1.0, 1.1]
