...
METRIC_DEFINITIONS = [
    {"event_name": "first_lap_lt_9s", "label": "first lap under 9s", "kind": "lap", "threshold": 9.0},
    {"event_name": "first_lap_lt_8s", "label": "first lap under 8s", "kind": "lap", "threshold": 8.0},
    {"event_name": "first_lap_lt_7.5s", "label": "first lap under 7.5s", "kind": "lap", "threshold": 7.5},
    {
        "event_name": "first_episode_len_ge_500",
        "label": "first episode length >= 500",
        "kind": "episode_length",
        "threshold": 500.0,
    },
    {
        "event_name": "first_episode_len_ge_500_mean_step_reward_gt_0_00",
    ...
    {
        "event_name": "first_episode_len_ge_500_mean_step_reward_gt_0_005",
        "label": "first episode length >= 500 and mean step reward > 0.005",
        "kind": "episode_length_and_reward",
        "length_threshold": 500.0,
        "reward_threshold": 0.005,
    },
    {
        "event_name": "first_episode_len_ge_500_mean_step_reward_gt_0_01",
