...
print(df.head(3))
# print(df['pose_x'][0:10])
# print(df['d_pose_x'][0:10])
...
# Train the model
model.fit(X_train, y_train, validation_data=(X_val, y_val), epochs=4, batch_size=8, shuffle=False, callbacks=[reduce_lr])
