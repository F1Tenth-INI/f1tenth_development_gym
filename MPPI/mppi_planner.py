...
from MPPI.mppi_settings import *
# from util import *
...
class MppiPlanner:
    ...
    def static_control_inputs(self):
        ...
        control_inputs = [
            ...
            NUMBER_OF_STEPS_PER_TRAJECTORY * [[0., 5.]],  # accelerate
            NUMBER_OF_STEPS_PER_TRAJECTORY * [[-1., 5.]],  # accelerate and left
            NUMBER_OF_STEPS_PER_TRAJECTORY * [[1., 5.]],  # accelerate and right
        ]
    ...
    def process_observation(self, ranges=None, ego_odom=None):
        ...
        # TODO: Estimate State
        # self.car_state = [
        #     pose_x, pose_y, 0. , 0., pose_theta,0.,0.
        # ]
