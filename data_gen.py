...
for repetition in range(number_of_repetitions):
    ...
    csv_name = path_save_to+'F1TENTH_' + 'Random input' + '_' + str(datetime.now().strftime('_%Y-%m-%d_%H-%M-%S')) + str(repetition) + '.csv'
    csv_path = create_csv_header(path_save_to, controller_name='Random input', dt=dt, csv_name=csv_name)
